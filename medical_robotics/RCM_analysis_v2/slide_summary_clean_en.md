...
- Task 2 — max entry-cone error: 41.8 mm; max tip-target error: 0.1 mm.
- Task 3 — max insertion Entry-RCM error: 8.9 mm; max skull violation: 0.0 mm; final target error: 0.1 mm.
- Task 4 — max Entry-RCM error: 10.7 mm; max tip-cone error: 37.4 mm.
...
- PASS: T2 entry-cone tracking — max task2_entry_cone_error_mm = 41.8 mm, threshold 50.0 mm.
- PASS: T2 tip fixed at target — max tip_target_error_mm = 0.1 mm, threshold 3.0 mm.
- PASS: T3 insertion Entry-RCM — max entry_rcm_error_mm = 0.4 mm, threshold 2.0 mm.
- PASS: T3 final target — max tip_target_error_mm = 3.0 mm, threshold 3.0 mm.
- PASS: T3 skull/corridor safety — max skull_violation_mm = 0.0 mm, threshold 0.0 mm.
- PASS: T4 Entry-RCM stability — max entry_rcm_error_mm = 1.7 mm, threshold 2.0 mm.
- PASS: T4 tip-cone tracking — max task4_tip_cone_error_mm = 26.3 mm, threshold 50.0 mm.