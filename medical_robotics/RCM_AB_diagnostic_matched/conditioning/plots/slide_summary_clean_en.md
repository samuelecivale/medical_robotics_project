...
- Task 2 — max entry-cone error: 25.0 mm; max tip-target error: 13.6 mm.
...
- PASS: T2 entry-cone tracking — max task2_entry_cone_error_mm = 25.0 mm, threshold 50.0 mm.
- FAIL: T2 tip fixed at target — max tip_target_error_mm = 13.6 mm, threshold 3.0 mm.
