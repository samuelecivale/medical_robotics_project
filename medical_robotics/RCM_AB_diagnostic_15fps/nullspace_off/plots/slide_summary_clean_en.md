...
- PASS: T2 entry-cone tracking — max task2_entry_cone_error_mm = 3.8 mm, threshold 50.0 mm.
- PASS: T2 tip fixed at target — max tip_target_error_mm = 0.9 mm, threshold 3.0 mm.